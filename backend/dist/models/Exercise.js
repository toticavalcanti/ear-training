...
const ExerciseSchema = new mongoose_1.Schema({
    ...
    content: {
        ...
        rhythms: [Number],
        midiSequence: {
            type: mongoose_1.Schema.Types.Mixed, // Usando Mixed type para o objeto complexo MIDISequence
            default: null
        }
    },
    answer: {
        type: mongoose_1.Schema.Types.Mixed, // Pode ser string ou array de strings
        required: true
    },
    requiresPremium: {
        type: Boolean,
